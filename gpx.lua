...
-- TODO: Calculate bearing            local bearing = 
            local delta_d = f(tp2.lat, tp2.lon, tp1.lat, tp1.lon, spheroid)
            ...
            print(tp2.time, total_t, delta_t, total_t + delta_t, total_d, delta_d, total_d+delta_d)
