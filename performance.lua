...
local function measure_new(name, f, timebase, accuracy)
   local m = {}
   ...
   local function measure(results, n_max, f)
      ...
      local n_max = n_max or 1/m.accuracy
      ...
      repeat
         ...
         --print(tm_total, n)
      until m.accuracy * results.t_sum >= m.timebase.resolution -- * 1.1
